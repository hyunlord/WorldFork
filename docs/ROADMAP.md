...
> **★ Tier 2 D11 — 본인 본질 변화 (2026-05-06)**:
> 단순 텍스트 어드벤처 → **텍스트 + 사이드뷰 시각화 hybrid 시뮬 RPG** 로 pivot.
> 자세한 내용 + 작품 매칭 디자인은 [`ROADMAP_V2_BARBARIAN.md`](ROADMAP_V2_BARBARIAN.md) 참고.
> 본 ROADMAP은 framework Single Source of Truth, V2는 Tier 2 D11+ 방향성 보강.
