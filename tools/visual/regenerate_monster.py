"""몬스터 재생성 (★ vision 검수 X 발견 시).

본 commit (★ Phase 4, vision 검수 직접 답):
- 노움: prompt 보강 (★ 본문 22화 적대 mood 본격)
"""
...
def main() -> int:
    print("=" * 80)
    print("Phase 4 — 몬스터 재생성 (★ vision 검수 X)")
    print("=" * 80)
    ...
    for target in REGENERATE_TARGETS:
        ...
        # 기존 파일 .v1.png 백업
        existing = OUTPUT_DIR / f"monster_{name}.png"
        if existing.exists():
