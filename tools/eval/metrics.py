...
# G-Eval 6축 — 1~5 정수. judge가 narrative를 평가.
#   ★ 기존 4축(문체/persona/고증/시스템)은 "오류부재"라 짧을수록 유리해 변별 실패
#   (터스한 9B가 풍부한 12B보다 높게 나옴). 품질 2축(구체성/몰입) 추가로 변별력 확보.
JUDGE_AXES = ("문체", "persona", "고증", "시스템", "구체성", "몰입")

_JUDGE_SYSTEM = (
    "당신은 한국어 던전 생존 게임 GM 서사의 엄정한 평가자다. "
    "아래 서사를 6축으로 1~5 정수 채점하라(5=최상, 변별력 있게 분산). JSON만 출력한다.\n"
    ...
    "- 구체성: 감각 묘사·디테일 풍부함 (★ 한 문장 이하거나 빈약하면 1~2)\n"
    "- 몰입: 독자를 끌어들이는 흡인력·서사 깊이\n"
    '출력 형식: {"문체":N,"persona":N,"고증":N,"시스템":N,"구체성":N,"몰입":N,"한줄평":"..."}'
)
