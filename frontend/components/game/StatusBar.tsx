...
export function StatusBar({ data, onMenu }: Props) {
  ...
  return (
    <div className="relative grid h-[50px] grid-flow-col items-center gap-6 border-b border-border-rune bg-gradient-to-b from-bg-panel to-bg-deep px-6 font-mono text-[0.8rem] shadow-[0_4px_12px_rgba(0,0,0,0.4)]">
      ...
      {data.mode === "dungeon" ? (
        <span className="flex items-center gap-2 text-text-mid">
          ...
          <span className="relative h-2.5 w-[100px] overflow-hidden rounded-[1px] border border-border-rune bg-bg-void shadow-[inset_0_1px_3px_rgba(0,0,0,0.6)]">
            <span
